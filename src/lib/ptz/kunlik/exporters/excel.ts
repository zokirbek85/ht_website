...
function writeImportInfoSheet(wb: ExcelJS.Workbook, ctx: ExportContext): void {
  ...
  const rules = [
    ...
    "Режа = фермернинг фақат Fyuchers шартномалари бўйича Шартнома миқдори (т) йиғиндиси; Forvard ва Vaqtincha saqlash терими ҳисобга олинади, лекин режага қўшилмайди.",
